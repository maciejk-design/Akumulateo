...
/* 1. Ukrycie szablonu Squarespace na stronie głównej i eliminacja pustego pola */
body.homepage {{
...
body.homepage #page-regions section.page-section,
body.homepage #sections > section {{
  display: none !important;
}}

/* Dyskretna stylizacja przycisku zarządzania ciasteczkami */
.manage-cookies-bar,
.cookie-banner-manager,
.cookie-banner-manager button,
button.manage-cookies-bar {{
