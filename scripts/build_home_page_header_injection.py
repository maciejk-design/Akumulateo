...
from snippets/squarespace/homepage-content.html and the enhanced CSS/JS wrapper.
"""
...
def main():
    ...
    header_wrapper = """<!-- 1. TAILWIND CSS CDN W HEAD (WYMUSZENIE ŁADOWANIA SIATKI I UTILITIES) -->
...
/* 7. TYPOGRAFIA I KONTRAST TEKSTÓW */
.akumulateo-root h1,
.akumulateo-root h2,
.akumulateo-root h3,
...
/* 10. KARTA WYRÓŻNIONA (NAJCZĘŚCIEJ WYBIERANA USŁUGA) */
...
.akumulateo-root .border-amber-500 {
  border-color: #f59e0b !important;
}

/* 11. BEZPIECZEŃSTWO I DOSTĘPNOŚĆ BANERA COOKIE */
.sqs-cookie-banner-v2,
.sqs-cookie-banner-v2-container,
[data-cookie-banner],
[data-cookie-banner-v2],
.manage-cookies-bar {
...
(function() {
  function mountAkumulateoHome() {
    if (document.getElementById('akumulateo-home-wrapper')) return;
